...
namespace c_sharp_console_arcade
{
    class Program
    {
        ...
        {
            Console.Write("Welcome to the C# version of rock, paper, scissors! This your chance to play this classic game against a computer. To start off, please enter your name: ");
            string name = Console.ReadLine();
            Console.Write($"Hello {name}! Now, choose rock, paper or scissors: ");
